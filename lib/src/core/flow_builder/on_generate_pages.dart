...
import 'package:local_card_trading/src/feature/my_collection/add_card_to_collection/view/add_card_to_collection_page.dart';
import 'package:local_card_trading/src/feature/my_collection/add_card_to_collection/view/selected_card_page.dart';
...
List<Page<dynamic>> onGenerateAppViewPages(
  ...
  var selectedCard = state.searchCardState;
  if (authState.user == User.empty) {
    ...
    return [
      HomeView.page(),
      if (authState.isAddCardPageOpen) SearchCard.page(),
